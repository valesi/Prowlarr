...
namespace NzbDrone.Core.Datastore
{
    ...
    public class ConnectionStringFactory : IConnectionStringFactory
    {
        ...
        public ConnectionStringFactory(IAppFolderInfo appFolderInfo, IConfigFileProvider configFileProvider)
        {
            ...
            MainDbConnectionString = _configFileProvider.PostgresHost.IsNotNullOrWhiteSpace() ? GetPostgresConnectionString("main") :
                GetConnectionString(appFolderInfo.GetDatabase());

            LogDbConnectionString = _configFileProvider.PostgresHost.IsNotNullOrWhiteSpace() ? GetPostgresConnectionString("log") :
        ...
        private string GetPostgresConnectionString(string dbName)
        {
            ...
            connectionBuilder.Database = $"{_configFileProvider.PostgresDb}-{dbName}";
